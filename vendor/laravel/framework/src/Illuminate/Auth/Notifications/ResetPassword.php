...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject(Lang::get('Modification du mot de passe'))
            ...
            ->line(Lang::get('Appuyer sur le button si-dessous pour modifier votre mot de passe'))
            ->action(Lang::get('Modifier Mot de passe'), $url)
